...
const docRef = doc(db, "users", user.uid);
  ...
  // Atualiza apenas os campos do formulário (não sobrescreve o role)
  await updateDoc(docRef, formData);

  // Atualiza estado mantendo os outros campos
  setExtraData((prev) => ({ ...prev, ...formData }));
  setShowModal(false);
} catch (error) {
...
return ( <div className="container mt-4"> <h2 className="text-primary mb-4">Meu Perfil</h2>
